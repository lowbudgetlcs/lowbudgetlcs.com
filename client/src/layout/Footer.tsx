      ...
      <ul className="flex gap-8 p-2">
        <li className="w-8 h-auto">
          <NavLink aria-label="Instagram Profile" target="_blank" to="https://www.instagram.com/lowbudgetlcs">
            <i className="hover:text-primary-light transition duration-300 bi bi-instagram text-4xl"></i>
          </NavLink>
        </li>
        <li className="w-8 h-auto">
          <NavLink aria-label="Discord Server" target="_blank" to="https://discord.com/invite/XfsEEq4aPC">
            <i className="hover:text-primary-light transition duration-300 bi bi-discord text-4xl"></i>
          </NavLink>
        </li>
        <li className="w-8 h-auto">
          <NavLink aria-label="Twitch Channel" target="_blank" to="https://www.twitch.tv/lowbudgetlcs">
            <i className="hover:text-primary-light transition duration-300 bi bi-twitch text-4xl"></i>
          </NavLink>
        </li>
        <li className="w-8 h-auto">
          <NavLink
            ...
            <i className="hover:text-primary-light transition duration-300 bi bi-youtube text-4xl"></i>
          </NavLink>
        </li>
      </ul>
      <div className="riotDisclaimer text-xs md:text-center p-2 text-text-secondary">
        <p className="mb-2">
