  ...
  return (
    <div className="aboutbg-white text-black dark:bg-black dark:text-white font-serif">
      ...
      <div className="flex flex-col items-center py-8 px-4">
        <div className="gameContainer w-full min-h-44 md:h-44 py-8 bg-gray flex flex-col md:flex-row">
          ...
          <div className="champKDA flex flex-col gap-2 py-2 md:px-4 items-center justify-center m-4">
            <div className="champion min-w-[50px] min-h-[50px] max-w-[50px] max-h-[50px] bg-dark-blue">Champ</div>
          ...
          <div className="fullStats flex flex-col md:flex-row gap-4">
            <div className="goldStats flex flex-col gap-2 items-center md:items-start justify-center">
              <p className="text-base">CS: <span className="text-white/60">400</span></p>
              <p className="text-base">CS/M: <span className="text-white/60">12</span></p>
              <p className="text-base">Gold: <span className="text-white/60">300000</span></p>
              <p className="text-base">Vision Score: <span  className="text-white/60">200</span></p>
            </div>
            <div className="damageStats flex flex-col gap-2 items-center md:items-start justify-center">
              <p className="text-base">Damage: <span className="text-white/60">5023443</span></p>
              <p className="text-base">Healing: <span className="text-white/60">5023512</span></p>
              <p className="text-base">Shielding: <span className="text-white/60">502343</span></p>
              <p className="text-base">Damage to Turrets: <span className="text-white/60">201442</span></p>
            </div>
            <div className="defenceStats flex flex-col gap-2 items-center md:items-start justify-center">
              <p className="text-base">Damage Taken: <span className="text-white/60">23424642</span></p>
              <p className="text-base">Self-Mitigated: <span className="text-white/60">3453452</span></p>
            </div>
          </div>
        </div>
      </div>
