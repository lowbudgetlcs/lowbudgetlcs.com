const IndividualStatCard = ({
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center px-4 border-gray border-2 bg-gray bg-opacity-20 rounded-md">
      <div className={`${iconBgColor} p-1 rounded-md`}>{icon}</div>
      <div className="text flex flex-col p-2 items-center sm:items-start">
