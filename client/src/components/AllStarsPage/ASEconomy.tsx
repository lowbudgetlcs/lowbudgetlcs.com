function ASEconomy() {
    ...
    return(<div className="flex flex-col gap-8 items-center p-2 md:p-4">
        <h2 className="relative text-xl font-bold my-4">Economy Group A <span className={`absolute -bottom-0.5 left-0 w-full h-1 rounded-md ${color}`}></span></h2>
        ...
        <h2 className="relative text-xl font-bold my-4">Economy Group B <span className={`absolute -bottom-0.5 left-0 w-full h-1 rounded-md ${color}`}></span></h2>
