...
const EconPerformance = ({ playerData }: { playerData: PlayerOverallStats }) => {
  return (
    <div className="performanceOverview grow">
      <h2 className="text-2xl font-bold border-b-2 border-border mb-4">Economy</h2>
      {/* Stat Boxes */}
      <div className="smallStatBoxes flex flex-col gap-4">
        ...
        <IndividualStatCard
          ...
          valueColor={
            playerData.avgCsPerMin >= 7 ? "text-blue" : playerData.avgCsPerMin < 7 && !playerData.roles.includes("TOP") ? "text-red" : "text-white"
          }
        />
        {/* Gold/Game */}
        <IndividualStatCard
