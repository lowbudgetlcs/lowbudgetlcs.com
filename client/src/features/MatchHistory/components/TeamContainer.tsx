...
const TeamContainer = ({team, teamPlayers, activeLink}: {team: TeamDto, teamPlayers: ParticipantDto[], activeLink: string}) => {
  return (
    <div className="team1Container md:w-1/2 bg-bg border border-border rounded-md p-4 flex flex-col gap-4">
      ...
      {activeLink === "Loadout/KDA" ? (
        <div className="playerContainer flex flex-col gap-2 w-screen md:w-[80vw] lg:w-full overflow-x-scroll no-scrollbar">
