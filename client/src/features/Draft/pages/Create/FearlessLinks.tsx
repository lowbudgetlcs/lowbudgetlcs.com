...
function FearlessLinks({
  ...
  const team1Link = `${import.meta.env.VITE_FRONTEND_DRAFT_URL ?? "https://draft.lowbudgetlcs.com/"}fearless/${fearlessCode}/${team1Code}`;
  const team2Link = `${import.meta.env.VITE_FRONTEND_DRAFT_URL ?? "https://draft.lowbudgetlcs.com/"}fearless/${fearlessCode}/${team2Code}`;
  const specLink = `${import.meta.env.VITE_FRONTEND_DRAFT_URL ?? "https://draft.lowbudgetlcs.com/"}fearless/${fearlessCode}/spectator`;
  const streamLink = `${import.meta.env.VITE_FRONTEND_DRAFT_URL ?? "https://draft.lowbudgetlcs.com/"}fearless/${fearlessCode}/stream`;
