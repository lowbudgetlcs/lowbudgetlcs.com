import { pgTable, pgSchema, unique, integer, text, boolean, serial, timestamp, foreignKey, varchar, type AnyPgColumn, index, char, bigint, jsonb, smallint, date, pgEnum } from "drizzle-orm/pg-core"
...
export const asTeams = pgTable("as_teams", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "public.as_teams_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	seasonId: integer("season_id").notNull(),
...
export const playerPerformances = pgTable("player_performances", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "public.player_performances_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
...
export const teamPerformances = pgTable("team_performances", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "public.team_performances_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	teamId: integer("team_id"),
...
export const teamGameData = pgTable("team_game_data", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "public.team_game_data_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
...
export const fearlessDraftLobbies = pgTable("fearless_draft_lobbies", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "public.fearless_draft_lobbies_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	fearlessCode: text("fearless_code").notNull(),
	team1Code: text("team1_code").notNull(),
	team2Code: text("team2_code").notNull(),
	team1Name: text("team1_name").notNull(),
...
export const gameDumps = pgTable("game_dumps", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "public.game_dumps_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	gameId: integer("game_id").notNull(),
	dump: jsonb().notNull(),
}, (table) => [
	foreignKey({
...
export const playerGameData = pgTable("player_game_data", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "public.player_game_data_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
...
export const gamesInWebsite = website.table("games", {
	id: serial().primaryKey().notNull(),
	shortcode: text().notNull(),
	gameNum: integer("game_num").notNull(),
	winnerId: integer("winner_id"),
...
export const draftLobbies = pgTable("draft_lobbies", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "public.draft_lobbies_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	shortcode: text(),
	blueCode: text("blue_code").notNull(),
	redCode: text("red_code").notNull(),
	lobbyCode: text("lobby_code").notNull(),
